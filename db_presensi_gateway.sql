...
--
-- Host: localhost:3306
-- Waktu pembuatan: 10 Jul 2020 pada 01.11
-- Versi server: 5.7.24
-- Versi PHP: 7.2.19
...
absensi_id`,
`kelas_id
`, `matakuliah_id`, `absensi_tgl`) VALUES
(6, 3, 3, '2020-02-28'),
(7, 2, 3, '2020-07-08'),
(8, 2, 3, '1996-08-07');
...
(11) NOT NULL,
  `administrator_username` varchar
(255) NOT NULL,
  `administrator_password` varchar
(255) NOT NULL,
  `administrator_nama` varchar
(255) NOT NULL,
...
`, `administrator_password`, `administrator_nama`, `administrator_level`) VALUES
...
detail_id`,
`absensi_id
`, `mahasiswa_id`, `detail_status`, `detail_ket`) VALUES
(9, 6, 8, 0, '8'),
(10, 6, 9, 1, '9'),
(11, 7, 8, 0, '8'),
(12, 7, 9, 0, '9'),
...
(255) NOT NULL,
  `dosen_nama` varchar
(255) NOT NULL,
  `dosen_jenis_kelamin` int
(11) NOT NULL,
  `dosen_alamat` varchar
(255) NOT NULL,
  `dosen_tmp_tgl_lahir` varchar
(255) NOT NULL,
  `dosen_agama` varchar
(255) NOT NULL,
  `dosen_jenjang_pendidikan` varchar
(255) NOT NULL,
  `dosen_status` varchar
(255) NOT NULL,
  `dosen_tgl_masuk` varchar
(255) NOT NULL,
  `dosen_email` varchar
(255) NOT NULL,
  `dosen_nohp` varchar
...
`dosen_nama`,
`dosen_jenis_kelamin
`, `dosen_alamat`, `dosen_tmp_tgl_lahir`, `dosen_agama`, `dosen_jenjang_pendidikan`, `dosen_status`, `dosen_tgl_masuk`, `dosen_email`, `dosen_nohp`) VALUES
...
kelas_id`,
`matakuliah_id
`, `kelas_nama`, `kelas_mahasiswa`) VALUES
...
(
  `mahasiswa_id` int
(11) NOT NULL,
  `mahasiswa_npm` varchar
(255) NOT NULL,
  `mahasiswa_nama` varchar
(255) NOT NULL,
  `mahasiswa_jenis_kelamin` int
(11) NOT NULL,
  `mahasiswa_alamat` varchar
(255) NOT NULL,
  `mahasiswa_tmp_tgl_lahir` varchar
(255) NOT NULL,
  `mahasiswa_agama` varchar
(255) NOT NULL,
  `mahasiswa_nohp_ortu` varchar
(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
mahasiswa_id`,
`mahasiswa_npm
`, `mahasiswa_nama`, `mahasiswa_jenis_kelamin`, `mahasiswa_alamat`, `mahasiswa_tmp_tgl_lahir`, `mahasiswa_agama`, `mahasiswa_nohp_ortu`) VALUES
...
matakuliah_id`,
`dosen_id
`, `matakuliah_nama`, `matakuliah_sks`) VALUES
(3, 2, 'Basis Data', 4);
...
--
ALTER TABLE `tb_absensi`
ADD CONSTRAINT `tb_absensi_ibfk_1` FOREIGN KEY
(`kelas_id`) REFERENCES `tb_kelas`
(`kelas_id`),
ADD CONSTRAINT `tb_absensi_ibfk_2` FOREIGN KEY
(`matakuliah_id`) REFERENCES `tb_matakuliah`
(`matakuliah_id`);
...
--
ALTER TABLE `tb_detail`
ADD CONSTRAINT `tb_detail_ibfk_1` FOREIGN KEY
(`absensi_id`) REFERENCES `tb_absensi`
(`absensi_id`),
ADD CONSTRAINT `tb_detail_ibfk_2` FOREIGN KEY
(`mahasiswa_id`) REFERENCES `tb_mahasiswa`
(`mahasiswa_id`);
...
--
ALTER TABLE `tb_kelas`
ADD CONSTRAINT `tb_kelas_ibfk_1` FOREIGN KEY
(`matakuliah_id`) REFERENCES `tb_matakuliah`
(`matakuliah_id`);
...
--
ALTER TABLE `tb_matakuliah`
ADD CONSTRAINT `tb_matakuliah_ibfk_1` FOREIGN KEY
(`dosen_id`) REFERENCES `tb_dosen`
(`dosen_id`);
COMMIT;
