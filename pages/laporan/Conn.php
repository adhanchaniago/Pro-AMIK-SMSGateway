...
function format_angka($nilai, $dibelakang_koma = 0, $penutup = "", $pemisah_koma = ",", $pemisah_ribuan = ".")
{
    if ($nilai == "") {
        $nilai = 0;
    }
    ...
    // $penutup = ,-
    // $dibelakang_koma = 2 -> ,00
    return number_format($nilai, $dibelakang_koma, $pemisah_koma, $pemisah_ribuan) . $penutup;
}
...
function alertBootstrap($jenis_alert = "success", $isi_pesan = "Isi Pesan.")
{
    $icon_alert = array(
        "success" => "check",
        "warning" => "warning",
    ...
    return "<div class='alert-list'><div class='alert alert-" . $jenis_alert . " alert-dismissible'>
